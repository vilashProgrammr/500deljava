...
module.exports = Promise.resolve()
    ...
    .then(function () { return Promise.resolve(require('programmr_openfile/lib/browser/programmr_openfile-frontend-module')).then(load) })
    .then(function () { return Promise.resolve(require('programmr_javamenu/lib/browser/programmr_javamenu-frontend-module')).then(load) })
